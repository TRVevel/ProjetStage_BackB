 ...
 *                   example: [description de l'erreur]
 */
router.post('/loans/:bookId', verifyTokenMiddleware, addLoan);
 ...
 *                   example: Erreur interne
 */
router.put('/loans/:loanId', verifyTokenMiddleware, updateLoan);
 ...
 *                   example: Erreur interne
 */
router.put('/loans/confirmed/:loanId', verifyTokenMiddleware, confirmLoan);
 ...
 *                   example: Erreur interne
 */
router.delete('/loans/canceled/:loanId', verifyTokenMiddleware, cancelLoan);
 ...
 *                   example: Erreur interne
 */
router.put('/loans/returned/:loanId', verifyTokenMiddleware, bookReturned);
